    ...
    int error_capacity)
{
    ...
    for (int row = 0; row < SonicG1JointCount; ++row) {
        ...
        candidate.source_joint_position[entry.source_index] = position;
        candidate.source_joint_velocity[entry.source_index] = velocity;
        candidate.off_axis_residual[entry.source_index] = off_axis_residual;
    }
