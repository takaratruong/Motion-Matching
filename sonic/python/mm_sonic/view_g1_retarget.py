...
def terrain_mesh(
    ...
    *,
    ...
    vertices = np.column_stack(
        (xy, terrain_height_g1(fit, xy, scale=scale, z_offset=z_offset))
    )
...
class _PFNNTerrainMotionViewer:
    def __init__(
        ...
        *,
        ...
        self.terrain_z_offset = terrain_z_offset
        self.model = mujoco.MjModel.from_xml_string(
    ...
    def step(
        ...
        **_ignored,
        ...
        terrain = terrain_height_g1(
            ...
            z_offset=self.terrain_z_offset,
        )
    ...
    try:
        ...
        if terrain == "auto-steps":
            ...
            print(
                ...
                f"scale {terrain_scale:g} | Z offset {terrain_z_offset:g} m | "
