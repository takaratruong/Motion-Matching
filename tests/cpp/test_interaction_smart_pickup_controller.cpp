...
void test_production_provider_configuration_is_explicit_and_strict() {
    ...
    const std::array<uint8_t, 32> expected_checkpoint_sha256{
        0xdaU, 0x0eU, 0x12U, 0xb9U, 0xafU, 0x04U, 0x82U, 0x50U,
        0x48U, 0xceU, 0x02U, 0xc7U, 0x61U, 0x8dU, 0x54U, 0x95U,
        0x44U, 0x69U, 0xe0U, 0x72U, 0x71U, 0x9fU, 0xc8U, 0x94U,
        0xcbU, 0xd4U, 0x16U, 0x5eU, 0xd4U, 0x78U, 0x8aU, 0xafU,
    };
