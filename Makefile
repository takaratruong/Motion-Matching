...
g1_reach_coverage_viewer: g1_reach_coverage_viewer.cpp \
  ...
  reach_straight_approach.cpp reach_straight_approach.h \
...
g1_interaction_episode_viewer: g1_interaction_episode_viewer.cpp \
  ...
  reach_return.cpp reach_return.h \
  ...
  $(LINUX_CONTROLLER_DEPS)
	$(CC) $(CONTROLLER_CXXFLAGS) -O3 -DNDEBUG -pthread -o $@$(EXT) \
	  ...
	  reach_placement.cpp reach_search.cpp reach_straight_approach.cpp \
	  interaction_hand_trajectories.cpp interaction_posture_ik.cpp \
	  interaction_ik.cpp interaction_pose.cpp interaction_target.cpp \
	  $(CFLAGS) $(LIBS)
...
g1_reach_coverage_probe: g1_reach_coverage_probe.cpp \
  ...
  g1_skeleton.h vec.h quat.h
	$(CXX) $(CONTROLLER_CXXFLAGS) -O3 -DNDEBUG -pthread -I. -o $@$(EXT) \
	  ...
	  reach_search.cpp reach_straight_approach.cpp \
	  interaction_hand_trajectories.cpp interaction_posture_ik.cpp \
	  interaction_ik.cpp \
...
CPP_TEST_BINS += $(CPP_TEST_DIR)/test_reach_straight_approach
CPP_TEST_BINS += $(CPP_TEST_DIR)/test_reach_return
...
LIVE_FLAT_SMART_PICKUP_SOURCES := \
  interaction_smart_pickup_controller.cpp \
  interaction_smart_pickup_scene.cpp
LIVE_FLAT_SMART_PICKUP_HEADERS := \
  interaction_smart_pickup_controller.h \
  interaction_smart_pickup_scene.h
...
INTERACTION_SMART_PICKUP_CONTROLLER_LINK_SOURCES := \
  ...
  interaction_sha256.cpp \
  interaction_pick_assist.cpp interaction_pick_slots.cpp \
  interaction_arrival.cpp $(INTERACTION_RUNTIME_SOURCES)
INTERACTION_SMART_PICKUP_CONTROLLER_HEADERS := \
  interaction_smart_pickup_controller.h interaction_smart_pickup_scene.h \
  ...
  interaction_funnel_follower.h interaction_funnel_timing.h \
  interaction_funnel_worker.h interaction_sha256.h \
  interaction_pick_assist.h interaction_pick_slots.h interaction_arrival.h \
  interaction_runtime.h interaction_controller_adapter.h \
  $(INTERACTION_PLACE_HEADERS) interaction_carry.h interaction_ik.h \
  interaction_rotation_gate.h g1_arm_joint_metadata.h \
...
$(CPP_TEST_DIR)/test_interaction_funnel_follower: tests/cpp/test_interaction_funnel_follower.cpp interaction_funnel_follower.cpp interaction_funnel_follower.h interaction_funnel_timing.cpp interaction_funnel_timing.h interaction_funnel_artifact.h | $(CPP_TEST_DIR)
	$(CXX) $(CPP_TEST_FLAGS) tests/cpp/test_interaction_funnel_follower.cpp interaction_funnel_follower.cpp interaction_funnel_timing.cpp -o $@
...
INTERACTION_LEARNED_PICKUP_BACKEND_LINK_SOURCES := \
  ...
  interaction_target.cpp interaction_pose.cpp
...
$(CPP_TEST_DIR)/test_interaction_learned_pickup_backend: tests/cpp/test_interaction_learned_pickup_backend.cpp $(INTERACTION_LEARNED_PICKUP_BACKEND_LINK_SOURCES) $(INTERACTION_LEARNED_PICKUP_BACKEND_HEADERS) | $(CPP_TEST_DIR)
	$(CXX) $(CPP_TEST_FLAGS) tests/cpp/test_interaction_learned_pickup_backend.cpp $(INTERACTION_LEARNED_PICKUP_BACKEND_LINK_SOURCES) -o $@

$(CPP_TEST_DIR)/test_interaction_learned_pickup_end_to_end: tests/cpp/test_interaction_learned_pickup_end_to_end.cpp tests/cpp/interaction_runtime_fixture.h $(INTERACTION_LEARNED_PICKUP_BACKEND_LINK_SOURCES) $(INTERACTION_LEARNED_PICKUP_BACKEND_HEADERS) $(INTERACTION_RUNTIME_SOURCES) $(INTERACTION_RUNTIME_HEADERS) | $(CPP_TEST_DIR)
	$(CXX) $(CPP_TEST_FLAGS) tests/cpp/test_interaction_learned_pickup_end_to_end.cpp $(INTERACTION_LEARNED_PICKUP_BACKEND_LINK_SOURCES) interaction_runtime.cpp interaction_carry.cpp interaction_ik.cpp interaction_attachment.cpp interaction_playback.cpp interaction_matcher.cpp interaction_features.cpp interaction_place_target.cpp interaction_place_collision.cpp interaction_place.cpp interaction_place_controller.cpp interaction_pickup_provenance.cpp -o $@

$(CPP_TEST_DIR)/test_interaction_smart_pickup_controller: tests/cpp/test_interaction_smart_pickup_controller.cpp $(INTERACTION_SMART_PICKUP_CONTROLLER_LINK_SOURCES) $(INTERACTION_SMART_PICKUP_CONTROLLER_HEADERS) | $(CPP_TEST_DIR)
	$(CXX) $(CPP_TEST_FLAGS) tests/cpp/test_interaction_smart_pickup_controller.cpp $(INTERACTION_SMART_PICKUP_CONTROLLER_LINK_SOURCES) -o $@
...
$(CPP_TEST_DIR)/test_reach_search: tests/cpp/test_reach_search.cpp \
  ...
  g1_skeleton.h vec.h quat.h | $(CPP_TEST_DIR)
	$(CXX) $(CPP_TEST_FLAGS) -pthread tests/cpp/test_reach_search.cpp \
	  reach_search.cpp reach_coverage.cpp reach_straight_approach.cpp \
	  reach_placement.cpp \
...
$(CPP_TEST_DIR)/test_reach_straight_approach: \
  tests/cpp/test_reach_straight_approach.cpp \
  reach_straight_approach.cpp reach_straight_approach.h \
  reach_coverage.cpp reach_coverage.h \
  interaction_hand_trajectories.cpp interaction_hand_trajectories.h \
  interaction_posture_ik.cpp interaction_posture_ik.h \
  interaction_ik.cpp interaction_ik.h g1_arm_joint_metadata.h \
  interaction_pose.cpp interaction_pose.h interaction_target.cpp \
  interaction_target.h interaction_database.h g1_skeleton.h vec.h quat.h \
  | $(CPP_TEST_DIR)
	$(CXX) $(CPP_TEST_FLAGS) tests/cpp/test_reach_straight_approach.cpp \
	  reach_straight_approach.cpp interaction_hand_trajectories.cpp \
	  interaction_posture_ik.cpp interaction_ik.cpp interaction_pose.cpp \
	  interaction_target.cpp -o $@

$(CPP_TEST_DIR)/test_reach_return: tests/cpp/test_reach_return.cpp \
  reach_return.cpp reach_return.h reach_search.h reach_coverage.h \
  reach_placement.cpp reach_placement.h reach_database.cpp reach_database.h \
  reach_motion.cpp reach_motion.h interaction_hand_trajectories.cpp \
  interaction_hand_trajectories.h interaction_posture_ik.cpp \
  interaction_posture_ik.h interaction_ik.cpp interaction_ik.h \
  g1_arm_joint_metadata.h interaction_pose.cpp interaction_pose.h \
  interaction_target.cpp interaction_target.h interaction_database.h \
  g1_skeleton.h vec.h quat.h | $(CPP_TEST_DIR)
	$(CXX) $(CPP_TEST_FLAGS) tests/cpp/test_reach_return.cpp \
...
$(CPP_TEST_DIR)/test_interaction_posture_ik: \
  ...
  interaction_posture_ik.cpp interaction_posture_ik.h \
  g1_arm_joint_metadata.h interaction_pose.cpp interaction_pose.h \
  interaction_ik.h interaction_matcher.h interaction_database.h \
  g1_skeleton.h vec.h quat.h | $(CPP_TEST_DIR)
