...
and planned-foothold XY/timing shortlist before batched terrain validation.
Candidate ordering uses a stable source-row tie break. This measured revision replaced the original width-256
